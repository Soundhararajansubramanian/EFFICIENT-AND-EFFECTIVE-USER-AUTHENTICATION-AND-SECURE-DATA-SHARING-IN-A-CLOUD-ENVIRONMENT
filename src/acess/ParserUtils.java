...
public class ParserUtils {
    ...
    public static int[][] GenerateAccessPolicy(String policy) throws PolicySyntaxException {
        ...
        System.out.println("Formatted Policy"+formattedPolicy);
        ...
        System.out.println("BT FIRST ELEMENT "+queue.size());
        int nextNodeLabel = 0;
        ...
        while (!queue.isEmpty()) {
            ...
            if (p.getType() == BinaryTreeNode.NodeType.LEAF) {
                ...
                System.out.println("BT FIRST ELEMENT "+p.getRight().toString());
